...
// TODO Auto-generated method stub
        ...
        protected void onPostExecute(String result) {
            ...
            List<ItemObjectClass> parsedObject = returnParsedJsonObject(result);
...
// TODO Auto-generated catch block
    ...
    private List<ItemObjectClass> returnParsedJsonObject(String result){

        List<ItemObjectClass> jsonObject = new ArrayList<ItemObjectClass>();

        JSONObject resultObject = null;

        JSONArray jsonArray = null;

        ItemObjectClass newItemObject = null;
        ...
        for(int i = 0; i < jsonArray.length(); i++){
            ...
            try {
                ...
                newItemObject = new ItemObjectClass(songName, songYear, songAuthor);
